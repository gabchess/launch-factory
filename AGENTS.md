...
Keep the root instructions brief. Read deeper files when the current stage needs them.

1. Entry: read [codex/launch-factory/SKILL.md](codex/launch-factory/SKILL.md); it routes each stage through `engine/specialists/`.
2. Claims Lock comes before any drafting. The reviewer checks all copy and creative assets. No invented features, limits, or pricing.
