...
The shared channel specialists and optional production recipes retain their source notes under `engine/specialists/`. Recipes supply reusable methods, with operator-supplied media and provider credentials. Historical decisions remain in `docs/adr/`; [ADR 0020](docs/adr/0020-v2-local-package-builder.md) defines v2.
