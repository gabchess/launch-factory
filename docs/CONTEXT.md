...
| Term | Meaning |
|---|---|
| Release folder | Source files, footage, and release.json for one product revision |
| Claim | A factual statement linked to an exact source quote |
| Claims Lock | A person's decision on a specific set of claims and source bytes |
| Specialist | A channel-specific drafting or review protocol used by the AI host |
